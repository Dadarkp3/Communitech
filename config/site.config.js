...
const config = {
  ...
  site_description: 'Desenvolver Inovações em Tecnologia e Educação para a inclusão de residentesde bairros periféricos no mundo digital e redução de desigualdades',
